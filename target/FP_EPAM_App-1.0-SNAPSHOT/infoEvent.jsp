    ...
    <article>
        ...
        <div class="w3-container">
            <table class="w3-table w3-bordered">
                ...
                <tbody>
                <%ArrayList<Report> list = (ArrayList<Report>) ReportDAO.getInstance().listReports(request.getParameter("id"),"Підтверджено");%>
        ...
        <div class="w3-container">
            <table class="w3-table w3-bordered">
                ...
                <tbody>
                <%ArrayList<Report> list1 = (ArrayList<Report>) ReportDAO.getInstance().listReports(request.getParameter("id"),"Пропонується");%>
                ...
                <tr>
                    ...
                    <td><%=reports.getSpeaker()%></td>
                    <td><%=reports.getStatus()%></td>
                    <td><a href="updateReport?id=<%=reports.getEvent_id()%>&report=<%=reports.getReport()%>&speaker=<%=loginSession%>&status=Очікує на підтвердження"><fmt:message key="submit" bundle="${lang}"/></a></td>
                </tr>
                <% } %>
                </tbody>
            </table>
